...
if (null !== form_config_element) {
        ...
        fetch(config_url)
            ...
            .then(json => {
                ...
                if (settings) {
                    ...
                    submitForm(settings.form_webhook, settings, data, form);
                } else {
    ...
    function handleMessage(settings, error = false, formEl) {
        ...
        // Primary target: element with id === settings.form_id
        var target = null;
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        const allFormRoots = document.querySelectorAll(
            ".wpcf7 form, .wpcf7-form, .gform_wrapper form, .wpforms-container form, .elementor-form, .wsf-form form, form.wsf-form, .ws-form form, form.ws-form, .frm-fluent-form, .brxe-form, .brxe-brf-pro-forms"
        );
