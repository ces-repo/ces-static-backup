(function(){
    ...
    function findFormBySettings(settings){
        ...
        // 1) Direct by id (covers many builders if DOM id matches config)
        if(settings.form_id){
        ...
        // 2) Elementor: hidden input name="form_id" equals settings.form_id
        ...
        // 4) Gravity Forms: hidden gform_submit equals id
        ...
        // 5) Fluent Forms: hidden _fluentform_id equals id or data-form-id attribute
