console.log('WC Instagram Shoots JS loaded v1.0');
(function($) {
    // Document ready
...
$(document).on('click', '.import-to-media', function(e) {
    e.preventDefault();
    
    const shootingId = $(this).data('id');
    const confirmImport = confirm(wc_instagram_shoots.confirm_import);
